...
ActiveRecord::Schema.define(version: 2020_05_30_174640) do
  ...
  create_table "survey_questions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["personality_type_id"], name: "index_survey_questions_on_personality_type_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.bigint "personality_type_id"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["personality_type_id"], name: "index_users_on_personality_type_id"
